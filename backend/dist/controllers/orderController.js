...
exports.cancelOrder = exports.updateOrder = exports.getOrdersByStatus = exports.getOrdersByUserID = exports.processPayment = exports.getOrders = exports.createOrder = void 0;
...
const createOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (result.rowsAffected[0]) {
            ...
            yield (0, exports.processPayment)(req, res);
        }
        else {
...
const processPayment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { orderID, totalAmount, source } = req.body;
        // Process payment using Stripe API or any other payment gateway
        // Example code to process payment with Stripe
        const paymentResult = yield stripe.charges.create({
        ...
        if (paymentResult.status === 'succeeded') {
            ...
            const updateResult = yield pool.request()
                .input('orderID', mssql_1.default.VarChar, orderID)
                .input('status', mssql_1.default.VarChar, 'completed')
